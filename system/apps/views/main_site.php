...
.textC {
 ...
 <body>
  ...
  <g class="box">
    ...
    <polygon class="yellow-box" points="395 285.6 762 258.9 732.7 336.1 431.6 350.2 395 285.6"/>
    <polygon class="yellow-box" points="709.7 622 933.7 622.3 960.9 662.9 931.9 700.1 708.7 699.4 709.7 622"/>
  </g>
...
// Set original states of elements
tl.set('.hide', {opacity: 0});
tl.set('.box', {scale: 0, transformOrigin: "50%, 50%"});
tl.set('.hide.big-white-circle', {scale: 0, transformOrigin:"50% 50%"});
tl.set('.hide.bottom-triangles', {scale: 0, rotation: 720, transformOrigin: "50%, 50%"});
tl.set('.hide.top-triangles', {y:20});
tl.set(".sq-bottom", {drawSVG:0});
tl.set(".sq-top", {drawSVG:0});


tl.to('.box', 2, {scale: 1, ease: Elastic.easeOut.config(1, 0.5)});

tl.staggerFrom(split404.chars, 1, {opacity:0, scaleX:0, ease: Power4.easeOut}, 0.05, "-=1");
tl.staggerTo(split404.chars, 1, {opacity: 1, scaleX:1, ease: Power4.easeOut}, 0.05, "-=1");

tl.staggerFrom(splitPage.chars, 1, {opacity:0, scaleX:0, ease: Power4.easeOut}, 0.05, "-=1");
tl.staggerTo(splitPage.chars, 1, {opacity: 1, scaleX:1, ease: Power4.easeOut}, 0.05, "-=1");

tl.staggerFrom(splitBack.chars, 1, {opacity:0, scaleX:0, ease: Power4.easeOut}, 0.05, "-=1.5");
tl.staggerTo(splitBack.chars, 1, {opacity: 1, scaleX:1, ease: Power4.easeOut}, 0.05, "-=1.5");

tl.to('.hide.big-white-circle', 1, {opacity:1, scale: 1, ease: Elastic.easeOut.config(1, 0.5)}, "-=1.5");

// turning spinning circles on at the end of the timeline, it's running in the background, defined in tlSpin timeline
tl.to('.hide.spin-circles', 1, {opacity: 1}, "-=1");

tl.to('.hide.tri-dots', 1, {opacity: 1}, "-=1.5");

tl.to('.hide.bottom-triangles', 2, {opacity: 1, scale: 1, rotation: 0}, "-=0.5");

tl.to('.start-tri', 1, {morphSVG: ".end-tri"}, "-=1.5");

tl.to('.hide.top-triangles', 1, {opacity:1, y: 0}, "-=1");





// New Timeline for repeating tweens
var tlSpin = new TimelineMax({repeat: -1});
tlSpin.set('.hide.spin-circles', {rotation: 0, transformOrigin: "50%, 50%", ease: Linear.easeNone})
