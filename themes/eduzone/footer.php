  <!-- Footer -->
    <footer class="site-footer">
     ...
     <!--                       <h5 class="footer-title">Latest Post</h5>-->
					...
					<!--					<img src="{_theme_url_}images/blog/recent-blog/pic1.jpg" width="200" height="143" alt=""> -->
					<!--				</div>-->
					...
					<!--			<div class="widget-post clearfix">-->
					<!--				<div class="dlab-post-media"> -->
					<!--					<img src="{_logo_}" width="200" height="160" alt=""> -->
					<!--				</div>-->
					<!--				<div class="dlab-post-info">-->
					<!--					<div class="dlab-post-header">-->
     ...
     <!--               </div>-->
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-sm-6 text-left "> <span>Copyright © {_YEAR_} <a href="{_base_url_}" target="_blank">{_title_}</a></span> </div>
                </div>
            </div>
        </div>
    </footer>
