...
$j(document).ready(function() {
    ...
    $j("#layered-navigation .block-title").click(function(){
        $j("#layered-navigation").toggleClass("nav-accordion");
    });
    $j("#page-title-wrap .page-title").click(function(){
        $j("#page-title-wrap").toggleClass("nav-accordion");
    });
