...
<div class="grocerycrud-container card card-flush pt-3 mb-5 mb-lg-10">
	...
	<div class="dataTablesContainer">
		<div class="card-header">
			<?php if(!$unset_add){?>
    			<div class="card-title">
    				<a role="button" class="add_button btn btn-sm btn-primary hidden-xs" href="<?php echo $add_url?>">
		...
		<div class="refresh-holder card-body">
			<?php echo $list_view?>
		</div>
	</div>
</div>