...
<form class="create-top-bar" novalidate method="POST" enctype="multipart/form-data">
    <input type="hidden" name="status" value="topbar">
	<div class="card card-border border-focus">
        
		<div class="card-header bg-primary text-white all-widget-card">
			<div><i class="fa fa-cog"></i>  Top Bar</div>
		...
		<div class="card-body md row " style="    margin: 0;    padding: 1px;   ">
            ...
            <div class="wrapper widget-area-body row">
                <?
                  ...
                  $i = 0;
                $allEvents = $this->SiteModel->getTopBar();
        ...
        <div class="card-header bg-success text-white" style="margin-top:1px;height:auto">
    ...
    $(document).on('submit','.create-top-bar',function(ee){
        ee.preventDefault();
        ...
        $.ajax({
            ...
            success : function(res){
                ...
                toastr.success('Topbar Data is Updated Successfully..');
            },
