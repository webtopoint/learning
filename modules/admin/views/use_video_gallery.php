...
$Gal = $this->GalleryModel->getVideoGallery();
?>
...
<div class="app-page-title">
    <div class="page-title-wrapper">
        <div class="page-title-heading">
            ...
            <div>Use Video Gallery
                <div class="page-title-subheading">Modify Video Gallery using this section.
                </div>
            </div>
        </div>
    </div>
...
<div class="col-md-12">
    <div class="main-card mb-3 card">
        <div class="card-body"><h5 class="card-title">Use Video Gallery on Pages</h5>
                ...
                foreach($Gal->result() as $gal)
                {
                    echo'<li class="list-group-item">
                        <h5 class="list-group-item-heading"><strong>'.$gal->gallery_name.'</strong> 
                            <a href="'.site_url('Admin/video-gallery/'.AJ_ENCODE($gal->id).'/view-videos').'" target="_blank"><button class="mb-2 mr-2 border-0 btn-transition btn btn-outline-primary"> View 
                                        </button></a>
                        </h5>
                        <p class="list-group-item-text">';
                        foreach ($allPage->result() as $page)
                        {
                            $chk = $this->GalleryModel->checkVideoGalleryUse(array('gal_id'=>$gal->id,'page_id'=>$page->id))?" checked":"";
