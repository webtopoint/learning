            ...
            <div class="box-header">
              <h3 class="box-title">Пользователи</h3>
                ...
                <div class="box-footer clearfix no-border">
                    <button type="button" class="btn btn-success pull-left"><i class="fa fa-plus"></i> Добавить</button>
                </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                <thead>
                  <th style="width: 70%;">Страница</th>
                ...
                <tr>
                  ...
                  <td class="mailbox-date"><a href="/admin/pages/edit/<?=$item['id'];?>"><i class="fa fa-edit"></i> Редактировать</a></td>
                    <td class="mailbox-attachment"><a href="#"><i class="fa fa-trash-o"></i> Удалить</a></td>
                </tr>
                <?php endforeach;?>
