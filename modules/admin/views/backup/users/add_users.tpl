  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"> <?= lang('text_Add_User') ?></li>
      </ol>
    </section>
        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              <img id="result_us" class="profile-user-img img-responsive img-circle" src="<?php echo base_url(); ?>upload/images/avatar/user.jpg" alt="User profile picture" />
            
              <h3 id="result_username" class="profile-username text-center"><?= lang('text_Login') ?></h3>

              <p class="text-muted text-center"><span id="result_surname"><?= lang('text_Surname') ?></span> &nbsp; <span id="result_name"><?= lang('text_Name') ?></span></p>
          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
              ...
              <div class="active tab-pane" id="settings">
                <form  method="post" action="<?php echo base_url(); ?>admin/users/add" class="form-horizontal">
                  <div class="form-group">
                    
                    <label for="inputName" class="col-sm-2 control-label"><?= lang('text_Login') ?></label>

                    <div class="col-sm-10">
                      <input name="username" type="text" class="form-control" id="inputNikName" placeholder="NikName" value="<?=set_value('username')?>" />
                      <?=form_error('username')?> <?php if(isset($error_name)){ ?><p>{error_name}</p><?php } ?>
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input name="email" type="email" class="form-control" id="inputEmail" placeholder="Email" value="<?=set_value('email')?>" />
                      <?=form_error('email')?>
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input name="surname" type="text" class="form-control" id="inputSureName" placeholder="Surname" value="<?=set_value('surname')?>" />
                      <?=form_error('surname')?>
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input name="name" type="text" class="form-control" id="inputName" placeholder="Name" value="<?=set_value('name')?>" />
                      <?=form_error('name')?>
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <textarea name="about_me" class="form-control" id="inputExperience" placeholder="about me 250 chars"><?=set_value('about_me')?></textarea>
                  ...
                  <div class="form-group">
                    <label for="inputExperience" class="col-sm-2 control-label">Язык</label>
                  <div class="col-sm-10">  
                  ...
                  <div class="form-group">
                    <label for="inputExperience" class="col-sm-2 control-label">Скин админки</label>
                  <div class="col-sm-10">  
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input name="password" type="text" class="form-control" id="inputName" placeholder="password" value="<?=set_value('password')?>" />
                      <?=form_error('password')?>
                    </div>
                  </div>
                  
                  <input name="img" id="us" type="hidden" class="form-control" value="<?=set_value('img')?>" /><br />
                  
                  <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                    <?php if($_SESSION['group_id'] == '0'){ ?>
                      <button name="add" type="submit" class="btn btn-danger" disabled=""><?= lang('text_add') ?></button>
                    <?php }else{ ?>  
                      <button name="add" type="submit" class="btn btn-danger"><?= lang('text_add') ?></button>
                    <?php } ?>
                    </div>
                  </div>
                </form>
...
<!-- Our main JS file -->
<script src="/modules/admin/views/dist/js/script.js"></script> 
