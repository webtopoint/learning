  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><?= lang('text_chenge') ?> - {title}</li>
      </ol>
    </section>
...
<form method="post" action="<?=base_url()?>admin/pages/update">            
            <!-- SELECT2 EXAMPLE -->
        ...
        <div class="box-body">
          <div class="row">   
            <div class="col-md-7">
              <div class="form-group">
                <label><?= lang('text_page_title') ?></label>
                  <input name="title" value="{title}" type="text" class="form-control" placeholder="Enter ...">
                  <?=form_error('title')?>
            ...
            <div class="col-md-3">
              <div class="form-group">
                <label>url</label>                
                  <input name="uri" value="{uri}" type="text" class="form-control" placeholder="Enter ...">
                  <?=form_error('uri')?>
        ...
        <div class="box-body">
            ...
            <div class="col-sm-12">
              <div class="form-group">
                <label>Meta description</label>
                      <textarea name="description" class="form-control" id="inputExperience" placeholder="Experience">{description}</textarea>
              </div>
            </div>
            ...
            <div class="col-md-12">
              <div class="form-group">
                <label>Meta keywords</label>
                  <input name="keywords" value="{keywords}" type="text" class="form-control" placeholder="Enter ...">
              </div>
            </div>
            ...
            <div class="col-md-12">
              <div class="form-group">
                <label><?= lang('text_page_tegs') ?></label>
                  <input name="tags" value="{tags}" type="text" class="form-control" placeholder="Enter ...">
              </div>
            </div>
            ...
            <div class="col-md-2">
                ...
                <?php if($_SESSION['group_id'] == '0'){ ?>
                    <input name="update" class="btn btn-block btn-success" type="submit" value="<?= lang('text_page_record') ?>" disabled=""/>
                <?php }else{ ?>
                    <input name="update" class="btn btn-block btn-success" type="submit" value="<?= lang('text_page_record') ?>" />
                <?php } ?>
                </div>
            </div>
