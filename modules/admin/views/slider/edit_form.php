                    ...
                    <div style="width:100%; overflow: hidden !important;" id="preview_div">
                        ...
                        <div id="backup_slider" style="display:none;">
                            <div class="ls-slide" <?php echo $style['full_slide_style']; ?> >
                                <img class="ls-bg out_background"  src="<?php echo base_url(); ?>public/temp/<?=CLIENT_ID?>/defaults/<?php echo $style['background']; ?>.jpg" /> 
                                <?php foreach($style['images'] as $image){ ?>
                                    <img class="ls-l out_<?php echo $image['name']; ?>" src="<?php echo base_url(); ?>public/temp/<?=CLIENT_ID?>/<?php echo $image['name']; ?>.png" style="<?php echo $image['style']; ?>" data-ls="<?php echo $image['data_ls']; ?>" >
                                <?php } ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <div class="prev_thumb" style="margin: 5px !important;">
                                    <img width="100px" src='<?php echo base_url(); ?>public/temp/<?=CLIENT_ID?>/background_<?php echo $row1['slider_id']; ?>.jpg' class="in_background" height="auto" >
                                </div>
                               <span class="pull-left btn btn-default btn-file">
                                    ...
                                    <label>Dimensions: 1280 x 720</label>
                                </span>
                            </div>
                        </div>
                    </div>
                        ...
                        ?>
                            <div class="form-group">
                                ...
                                <div class="col-sm-6 imager">
                                    <div class="prev_thumb" style="margin: 5px !important;">
                                        <img width="100px" class="in_<?php echo $image['name']; ?>" src='<?php echo base_url(); ?>public/temp/<?=CLIENT_ID?>/<?php if(in_array($image['name'], $oimgs)){ echo $row1['slider_id'].'_'.$image['name']; $same = 'same';} else { echo 'defaults/'.$image['name']; $same = 'no';} ?>.png' height="auto" >
                                    </div>
