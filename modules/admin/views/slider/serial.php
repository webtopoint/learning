                    ...
                    <ol class="dd-list">
                        ...
                        <li class="dd-item row" data-id="<?php echo $row['slider_id']; ?>">
                            <div class="dd-handle col-md-12" style="cursor: ns-resize;moz-user-select: none; -khtml-user-select: none; -webkit-user-select: none; -o-user-select: none; ">
                            	<div class="col-md-8">
                            	   <img class="img-responsive thumbnail img-slider" style="margin-bottom:0px !important;" src="<?php echo base_url(); ?>public/temp/<?=CLIENT_ID?>/background_<?php echo $row['slider_id']; ?>.jpg" />
                                </div>
                                <div class="col-md-4">
                                	<?php echo $row['title']; ?>
                                </div>
