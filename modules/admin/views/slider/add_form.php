    ...
    <div class="panel-body">
          <div class="col-md-12">
            ...
            ?>
                ...
                <div class="col-md-12 row margin-top-30">
                    <div class="col-sm-6">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label class="col-sm-12 control-label" for="demo-hor-inputemail">
                        ...
                        <?php foreach($style['images'] as $image){ ?>
                            <div class="form-group">
                                ...
                                <div class="col-sm-12 imager">
                                    ...
                                    <span class=" btn btn-default btn-file" style="margin-right:5px;">
                                        <?php echo translate('select_image');?>
                                        <input type="file" name="<?php echo $image['name']; ?>" class="otherimg imgr add-tooltip">
                                    </span>
                                    <div class=' btn btn-default cleanr'>
