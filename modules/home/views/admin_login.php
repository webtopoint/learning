	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('<?=base_url('public/login/')?>images/bg-01.jpg');">
			<div class="wrap-login100 p-t-30 p-b-50" >
				...
				<form action="<?=site_url('Admin-login')?>" method="post" class="login100-form validate-form p-b-33 p-t-5" style="background-color: rgb(0,0,0,0.9);box-shadow:0 0 20px 0 black inset" autocomplete="off">

					<div class="wrap-input100 validate-input" data-validate = "Enter username">
						<input class="input100" type="email" name="username" placeholder="User name" autofocus="">
