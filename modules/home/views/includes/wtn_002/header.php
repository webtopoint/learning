...
<head>
  ...
  <link href="<?=site_url('public/theme/'.FileDirecory)?>/css/bootstrap.css" rel="stylesheet" />
  <link href="<?=site_url('public/theme/'.FileDirecory)?>/css/bootstrap-responsive.css" rel="stylesheet" />
  <link href="<?=site_url('public/theme/'.FileDirecory)?>/css/fancybox/jquery.fancybox.css" rel="stylesheet">
  <link href="<?=site_url('public/theme/'.FileDirecory)?>/css/jcarousel.css" rel="stylesheet" />
  <link href="<?=site_url('public/theme/'.FileDirecory)?>/css/flexslider.css" rel="stylesheet" />
  <link href="<?=site_url('public/theme/'.FileDirecory)?>/css/style.css" rel="stylesheet" />
  <!-- Theme skin -->
  <link href="<?=site_url('public/theme/'.FileDirecory)?>/skins/default.css" rel="stylesheet" />
  <!-- Fav and touch icons -->
  <link rel="apple-touch-icon-precomposed" sizes="144x144" href="<?=site_url('public/theme/'.FileDirecory)?>/ico/apple-touch-icon-144-precomposed.png" />
  <link rel="apple-touch-icon-precomposed" sizes="114x114" href="<?=site_url('public/theme/'.FileDirecory)?>/ico/apple-touch-icon-114-precomposed.png" />
  <link rel="apple-touch-icon-precomposed" sizes="72x72" href="<?=site_url('public/theme/'.FileDirecory)?>/ico/apple-touch-icon-72-precomposed.png" />
  <link rel="apple-touch-icon-precomposed" href="<?=site_url('public/theme/'.FileDirecory)?>/ico/apple-touch-icon-57-precomposed.png" />
  <link rel="<?=site_url('public/theme/'.FileDirecory)?>/shortcut icon" href="ico/favicon.png" />
              ...
              <div class="navigation">
                <nav>
                  ...
                  foreach($query->result() as $k => $data) {
                   ...
                   $pageCount = 0;
                  function get_menu($items,$class = 'nav topnav') {
                      ...
                      foreach($items as $key=>$value) {
                        ...
                        if(array_key_exists('child',$value))
                          $html.= '<li class="dropdown"><a href="#" '.$value['target'].' class="menu-css '.$activeCss.'">'.$value['page_name'].'</a>'; 
                        else
                          $html.= '<li class=""><a href="'.$_page_url.'.html" '.$value['target'].' class="menu-css '.$activeCss.'">'.$value['page_name'].'</a>';
