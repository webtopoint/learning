  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#"><i class="fa fa-file-text"></i> страницы</a></li>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label>Text</label>
                  <input value="{title}" type="text" class="form-control" placeholder="Enter ...">
              </div>
            </div>
            <!-- /.col -->
            <div class="col-md-3">
            ...
            <div class="col-sm-9">
              <div class="form-group">
                <label>Meta keywords</label>
                      <textarea class="form-control" id="inputExperience" placeholder="Experience">{description}</textarea>
              </div>
            </div>
            ...
            <div class="col-md-9">
              <div class="form-group">
                <label>Meta description</label>
                  <input value="{keywords}" type="text" class="form-control" placeholder="Enter ...">
              </div>
            </div>
